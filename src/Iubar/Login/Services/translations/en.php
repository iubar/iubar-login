...
return array(
	...
	"FEEDBACK_FB_USER_MERGED_SUCCESSFUL" => "Facebook user merged with already existing user.",
	"FEEDBACK_FB_USER_CREATED_SUCCESSFUL" => "Facebook user created successfully.",	
	"FEEDBACK_FB_USER_MERGED_SUCCESSFUL" => "Facebook user merged successfully with the existing user.",
	"FEEDBACK_FB_USER_MERGED_FAILED" => "Sorry, acount merge process failed.",
	"FEEDBACK_FB_ID_ALREADY_TAKEN" => "Facebook user\'s id aleady in use",
	"FEEDBACK_FB_EMAIL_ALREADY_TAKEN" => "Facebook user\'s email aleady in use",
	"FEEDBACK_FB_USER_CREATED_SUCCESSFUL" => "Facebook user created successfully.",
	"FEEDBACK_FB_USER_CREATED_FAILED" => "Facebook user creation failed",
		
	"FEEDBACK_GO_USER_MERGED_SUCCESSFUL" => "Google user merged with already existing user.",
	"FEEDBACK_GO_USER_CREATED_SUCCESSFUL" => "Google user created successfully.",
	"FEEDBACK_GO_USER_MERGED_SUCCESSFUL" => "Google user merged successfully with the existing user.",
	...
	"FEEDBACK_WELCOME_MAIL_SENDING_FAILED" => "Sorry, we could not send you an welcome mail. Your account has NOT been created.",
	"FEEDBACK_WELCOME_MAIL_SENDING_ERROR" => "Welcome mail could not be sent due to: ",
	"FEEDBACK_WELCOME_MAIL_SENDING_SUCCESSFUL" => "A welcome mail has been sent successfully.",
);